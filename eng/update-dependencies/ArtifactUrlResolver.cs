...
internal interface IAssetUrlResolver
{
...
internal class AssetUrlResolver(
    HttpClient httpClient,
    ILogger<AssetUrlResolver> logger)
    : IAssetUrlResolver
{
    private readonly HttpClient _httpClient = httpClient;
    private readonly ILogger<AssetUrlResolver> _logger = logger;

    // Adapted from https://github.com/dotnet/arcade/blob/14abacb37f7840c8996ccff99edd0fe302464c85/src/Microsoft.DotNet.Build.Tasks.Feed/src/PublishArtifactsInManifestBase.cs#L913-L977
    public string ResolveAssetUrl(Asset asset)
    {
        ...
        AssetLocation location = blobStorageLocations.FirstOrDefault()
        ...
        string url = $"{location.Location}/{asset.Name}";
